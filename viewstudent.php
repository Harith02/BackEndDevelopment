...
<body class="body">
    ...
    <div class="container2">
        ...
        <div class="content">
                <table> 
                    <tr>
                        ...
                        <th width="350px">Medical Info<br><hr></th>
                        <th width="150px">Class ID<br><hr></th>
                        <th width="150px">Year of Study<br><hr></th>
                    </tr>
                        
                    <?php
                            
                            $sql = mysqli_query($link, "SELECT pupils.pupil_id, pupils.firstname, pupils.surname, pupils.Saddress, 
                            pupils.medical_info, pupils.gender, pupils.class_id, classes.class_name AS year_of_study 
                            FROM pupils
        ...
        <div class="makeupdate">
            <a class="update" href="updatestudent.php">Update Student Record</a>
            <label>/</label>
            <a class="update" href="deletestudent.php">Delete Student Record</a>
        </div>
    </div>
