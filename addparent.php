...
<body class="body">
    ...
    <main>
        <div class="student">
            ...
            <form method="post" action="addparent.php" id="form1">
        ...
        <?php
          ...
          if (isset($_POST['submit'])) {
              ...
              $sql = "INSERT INTO parents (firstname,surname,Paddress, phone_number, annual_salary, relationship, email) 
              VALUES ('$sname','$lname','$add','$fon','$sal','$rel','$email')";
