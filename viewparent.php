...
<body class="body">
    ...
    <div class="container2">
        ...
        <div class="content">
                <table> 
                    <tr>
                        ...
                        <th width="150px">Relationship<br><hr></th>
                    </tr>
                        
                    <?php
                            
                        $sql = mysqli_query($link, "SELECT parent_id, firstname,surname,Paddress,phone_number,annual_salary,
                        email,relationship  FROM parents");
        ...
        <div class="makeupdate">
            <a class="update" href="updateparent.php">Update Parent/Guardian Record</a>
            <label>/</label>
            <a class="update" href="deleteparent.php">Delete Parent/Guardian Record</a>
        </div>
    </div>
