        ...
        <div class="student">
         ...
         <?php
          ...
          if (isset($_POST['submit'])) {
              ...
              $sql = "INSERT INTO teachers (firstname,surname,Taddress, phone_number, annual_salary, 
              background_info, email, subject_of_expertise, class_id) 
              VALUES ('$sname','$lname','$add','$fon','$sal','$back','$email','$soe','$cid')";
