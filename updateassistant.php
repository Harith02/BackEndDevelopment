...
<body class="body">
    ...
    <main>
        <div class="student">
            <h2>UPDATE TEACHING ASSISTANT</h2>
         ...
         <?php
          ...
          if (isset($_POST['submit'])) {
              ...
              $sql = "UPDATE assistant SET firstname = '".$_POST['first_name']."', surname = '".$_POST['last_name']."', 
              phone_number = '".$_POST['phone_num']."', email = '".$_POST['email']."', Aaddress = '".$_POST['address']."', 
              teacher_id = '".$_POST['teacher_id']."' WHERE teachasst_id = '".$id."'";
