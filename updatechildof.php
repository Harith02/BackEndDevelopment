...
<body class="body">
    ...
    <main>
        <div class="student">
            <h2>UPDATE STUDENT & PARENT</h2>
            <form method="post" action="updatechildof.php" id="form2">
                ...
                <div class="input_field">
                    ...
                    <input type="text" name="pupil_id" class="details" required>
                </div>
                <div class="input_field">
                    <label>Parent ID</label>
                    <input type="text" name="parent_id" class="details" required>
                </div>
                <div class="input_field">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE childof SET pupil_id = '".$_POST['pupil_id']."', parent_id = '".$_POST['parent_id']."' 
            WHERE relation = '".$id."'";
