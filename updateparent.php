...
<body class="body">
    ...
    <main>
        <div class="student">
            <h2>UPDATE PARENT/GUARDIAN</h2>
            <form method="post" action="updateparent.php" id="form1">
                ...
                <div class="input_field"> 
                    <label>Address</label>
                    <textarea name="address" id="address_par" class="details" required></textarea> 
                </div>    
                <div class="input_field">
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql = "UPDATE parents SET firstname = '".$_POST['first_name']."', surname = '".$_POST['last_name']."',
                phone_number = '".$_POST['phone_num']."', annual_salary = '".$_POST['salary']."', email = '".$_POST['email']."', 
                relationship = '".$_POST['value']."', Paddress = '".$_POST['address']."'
                WHERE parent_id = '".$id."'";
