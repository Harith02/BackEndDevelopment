...
<body class="body">
    ...
    <div class="container2">
        ...
        <div class="content">
                <table> 
                    ...
                    <?php
                        ...
                        $sql = mysqli_query($link, "SELECT class_id,class_name,capacity  FROM classes");
        ...
        <div class="makeupdate">
            <a class="update" href="updateclass.php">Update Class Record</a>
            <label>/</label>
            <a class="update" href="deleteclass.php">Delete Class Record</a>
        </div>
    </div>
