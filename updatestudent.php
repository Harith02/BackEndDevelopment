    ...
    <main>
        <div class="student">
            ...
            <form method="post" action="updatestudent.php">
                ...
                <div class="input_field"> 
                    <label>Address</label>
                    <textarea name="address" id="address_stu" class="details" required></textarea> 
                </div>
                <div class="input_field"> 
                    <label>Medical Information</label>
                    <textarea name="med_info" id="med_info" class="details" required></textarea> 
                </div>
                <div class="input_field">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE pupils SET firstname = '".$_POST['first_name']."', surname = '".$_POST['last_name']."', gender = '".$_POST['value']."',
             Saddress = '".$_POST['address']."', medical_info = '".$_POST['med_info']."', class_id = '".$_POST['class_id']."' 
             WHERE pupil_id = '".$id."'";
