...
<body class="body">
    ...
    <main>
        <div class="student">
            ...
            <form method="post" action="updateteacher.php">
                ...
                <div class="input_field">
                    ...
                    <input type="text" name="soe" class="details" required>
                </div>
                <div class="input_field">
                    <label>Annual Salary</label>
                    <input type="text" name="salary" class="details" required>
                </div>
                <div class="input_field"> 
                    <label>Address</label>
                    <textarea name="address" id="address_teach" class="details" required></textarea> 
                </div>
                <div class="input_field"> 
                    <label>Background Information</label>
                    <textarea name="background" id="background" class="details" required></textarea> 
                </div>
                <div class="input_field">
                    <label>Class ID</label>
                    <input type="text" name="class_id" class="details" required>
                </div>
                <div class="input_field">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE teachers SET firstname = '".$_POST['first_name']."', surname = '".$_POST['last_name']."', 
            phone_number = '".$_POST['phone_num']."', annual_salary = '".$_POST['salary']."', subject_of_expertise = '".$_POST['soe']."', 
            email = '".$_POST['email']."', Taddress = '".$_POST['address']."', background_info = '".$_POST['background']."', 
