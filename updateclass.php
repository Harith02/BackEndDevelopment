...
<body class="body">
    ...
    <main>
        <div class="student">
            ...
            <form method="post" action="updateclass.php">
                ...
                <div class="input_field">
                    ...
                    <input type="text" name="class_name" class="details" required>
                </div>
                <div class="input_field">
                    <label>Class Capacity</label>
                    <input type="text" name="capacity" class="details" required>
                </div>
                <div class="input_field">
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE classes SET class_name = '".$_POST['class_name']."', capacity = '".$_POST['capacity']."' 
            WHERE class_id = '".$id."'";
