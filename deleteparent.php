...
<body class="body">
    ...
    <main>
        <div class="student">
            <h2>DELETE PARENT/GUARDIAN
            <p style="font-size:12px;" align=center>( Make sure the the parent relation is deleted) </p>
            </h2>
            <form method="post" action="deleteparent.php" id="form1">
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql = " DELETE FROM parents WHERE parent_id = '$id' AND firstname = '$sname'";
